...
<head>
    ...
    <!-- Document Title -->
    <title>{{ $project->title }} | {{ $project->designer }}</title>
...
<body>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-3 col-6">
                            ...
                            <div class="bizagn--logo">
                                <a href="index.html"><img src="/assets/images/logo.png" alt="" class="img-fluid"
                                        data-rjs="2"></a>
                            </div>
                            <!-- End of logo -->
                        </div>
                                ...
                                <ul>
                                    ...
                                    <li class="menu-item-has-children"><a href="#">Blog</a>
                                        <ul class="sub-menu">
                                            ...
                                            <li><a href="blog-with-sidebar.html">Blogs Sidebar</a></li>
    ...
    {{-- <div class="bizagn--page-title">
        ...
        <p>Tijgers ook zwijnen planter jungles gewicht had met een. koopen er de gedurende nabijheid op Heb alais assam.</p>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-4">
                    <ul class="bizagn--project-meta">
                        <li><span>Catagories:</span> {{ $project->category }} </li>
                        <li><span>Date:</span> {{ $project->date }}</li>
                        <li><span>Price:</span> {{ $project->price }}</li>
                        <li><span>Duration:</span> {{ $project->duration }}</li>
                        <li><span>Client:</span> {{ $project->client }}</li>
                        <li><span>Designer:</span> {{ $project->designer }}</li>
                        ...
                        <div class="col-lg-3 col-md-6">
                            ...
                            <div class="bizagn--relpro-item">
                                <div class="bizagn--relpro-thumb">
                                    <a href="#"><img src="{{ $item->image }}" alt="{{ $item->title }}"
                                            class="img-fluid"></a>
                                </div>
                                <div class="bizagn--relpro-data">
                                    ...
                                    <h4> <a href="/projects/{{ $item->id }}"> {{ $item->title }} </a></h4>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="bizagn--widget footer-widget">
                            <div class="bizagn--widget-content">
                                ...
                                <p>Er alluviale hellingen wegwerpen nu er op schippers. Mislukking wat ook voorloopig
                                    verdedigen per inlandsche dan. Punt al in belangrijk specerijen nu ook voorloopig.
                                </p>
                        ...
                        <div class="bizagn--widget footer-widget">
                            ...
                            <div class="bizagn--widget-content">
                                <ul class="bizagn--menu">
                                    <li><span>Adress : </span> 58 Kelly Manor, New Ameliaton, M28 7XP</li>
                            ...
                            <div class="bizagn--widget-content">
                                ...
                                <form class="newsletter-form"
                                    ...
                                    <button type="submit" class="btn bizagn--base-btn">
                                        ...
                                        Subscribe
                                        <img src="/assets/images/btn-right-arrow.svg" alt=""
                                            class="svg right">
                                    </button>
                                </form>
                            </div>
        ...
        <div class="bizagn--footer-bottom">
            <div class="container">
                <div class="bizagn--footer-cradit text-center">
                    <p>Copyright © 2019 Drone Agency by Themelooks. All Rights Reserved.</p>
                </div>
            </div>
        </div>
